                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col">
                                <div class="mb-3 ">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3">{{ $loker->alamat }}</textarea>
                                    @error('alamat')
                                        <span class="d-block text-danger mt-1"> {{ $message }} </span>
                                    @enderror
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col">
                                <div class="mb-3 ">
                                    ...
                                    @enderror
                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                    <textarea class="form-control" placeholder="Masukan Deskripsi Pekerjaan" id="deskripsi" name="deskripsi"
                                        rows="3"></textarea>
                                    @error('deskripsi')
                                        <span class="d-block text-danger mt-1"> {{ $message }} </span>
                                    @enderror
                                    <label for="kualifikasi" class="form-label">Kualifikasi</label>
                                    <textarea class="form-control" placeholder="Masukan Kualifikasi yang dibutuhkan" id="kualifikasi" name="kualifikasi"
                                        rows="3"></textarea>
                                    @error('kualifikasi')
                                        <span class="d-block text-danger mt-1"> {{ $message }} </span>
                                    @enderror
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukan Alamat Perusahaan"></textarea>
                                    @error('alamat')
                                        <span class="d-block text-danger mt-1"> {{ $message }} </span>
                                    @enderror
                                    <label for="email" class="form-label">E-Mail</label>
